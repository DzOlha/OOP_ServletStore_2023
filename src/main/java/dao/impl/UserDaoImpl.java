...
public class UserDaoImpl implements UserDao {
    ...
    private static final String USER_BY_NAME_QUERY =
            "SELECT users.id, name, password, type, blocked FROM users WHERE users.name = ?";
    ...
    private static final String ADD_USER_QUERY =
            "INSERT INTO users(name, password, blocked, type) VALUES (?, ?, ?, ?)";
    ...
    public User findUserByName(String name) {
        ...
        ConnectionPool cp = ConnectionPool.getConnectionPool();
        try (Connection connection = cp.getConnection()) {
            PreparedStatement prepareStatement = connection.prepareStatement(USER_BY_NAME_QUERY);
